    ...
    <main className="flex min-h-dvh flex-col bg-background">
      ...
      <div className="flex flex-1 flex-col px-5 pb-10 pt-8">
        ...
        <div className="mx-auto mt-8 flex w-full max-w-sm flex-col gap-3">
          <Link to="/site" className="rounded-3xl bg-card px-5 py-6 text-center shadow-[var(--shadow-border)]">
          ...
          <Link to="/app" className="rounded-3xl bg-foreground px-5 py-6 text-center text-background">
